...
import { createNewDatabase, viewDatabase } from "./modules/database.js";
...
console.warn(
  "Using app.js compatibility layer - consider updating your imports to use the modular structure directly"
);
